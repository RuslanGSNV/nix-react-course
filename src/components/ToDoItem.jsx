...
export const ToDoItem = ({item, index, deletedItems, setDeletedItems, openEditNote, setOpenEditNote, items, setItems, checkboxChecked}) => {
    ...
    return(
        ...
        <div style={styles.note_block}>
              ...
              <div style={styles.edit_block}>
                <EditNote items={items} setItems={setItems} item={item} openEditNote={openEditNote} setOpenEditNote={setOpenEditNote}/>
              </div>
          </div>
